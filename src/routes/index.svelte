        ...
        >
          <div class="lg:py-24">
            ...
            <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
              We are immensely passionate to let you enjoy surfing on this wave
            ...
            <div class="mt-10 sm:mt-12">
              <form action="#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                ...
                <p class="mt-3 text-sm text-gray-300 sm:mt-4">
                  Start your free newsletter subscription. Never miss our latest
                  and greatest technology updates.
                </p>
              </form>
            </div>
          </div>
  ...
  <div class="relative bg-white py-16 sm:py-24 lg:py-32">
    ...
    >
      ...
      <p
        class="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl"
      >
        Everything you need to bring your imagination into reality
      </p>
      <p class="mt-5 max-w-prose mx-auto text-xl text-gray-500">
        No matter how brilliant your idea is, if it takes more time to bring
        your IT project to life, rivals will pull ahead of you and surprise
        target audience with a similar good much earlier.
      </p>
      <div class="mt-12">
          ...
          <div class="pt-6">
            <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
              <div class="-mt-6">
                ...
                <p class="mt-5 text-base text-gray-500">
                  Encrypts data sent over your web to ensure that eavesdroppers
          ...
          <div class="pt-6">
            <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
              <div class="-mt-6">
                ...
                <p class="mt-5 text-base text-gray-500">
                  Ensures your data and applications are readily available to
                  authorized users. You always have a reliable method to access
                  yours.
                </p>
              </div>
            </div>
          ...
          <div class="pt-6">
            <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
              <div class="-mt-6">
                ...
                <p class="mt-5 text-base text-gray-500">
                  Helps restore devices during disaster recovery and restore
                  data. It is vital for protection against data loss.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            <img
              ...
              src="https://images.unsplash.com/photo-1541535881962-3bb380b08458?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=734&q=80"
              alt=""
            />
          </div>
        </div>
    ...
    <div class="relative">
      ...
      >
        ...
        <p class="mt-5 mx-auto max-w-prose text-xl text-gray-500">
          Some of our pieces related to technology tools can be found in these
          articles. We are on a mission to spread information to make businesses
          tech literate.
        </p>
      </div>
      <div
  ...
  <div class="relative bg-gray-900">
    ...
    >
      <img
        ...
        src="https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=60&sat=-100"
        alt=""
      />
      <div
        aria-hidden="true"
    ...
    >
      <div class="md:ml-auto md:w-1/2 md:pl-10">
        ...
        <p class="mt-3 text-lg text-gray-300">
          We care and love what we do, that is to help you defining and
          transform your businesses in Digital Ecosystem with Innovative
          Technology
        </p>
        <div class="mt-8">
