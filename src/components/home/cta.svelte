...
<div class="relative bg-gray-900">
  ...
  >
    <img
      ...
      src="https://images.unsplash.com/photo-1526948531399-320e7e40f0ca?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=60&sat=-100"
      alt=""
    />
    <div
      aria-hidden="true"
  ...
  >
    <div class="md:ml-auto md:w-1/2 md:pl-10">
      ...
      <p class="mt-3 text-lg text-gray-300">
        We care and love what we do, that is to help you defining and transform
        your businesses in Digital Ecosystem with Innovative Technology
      </p>
      <div class="mt-8">
